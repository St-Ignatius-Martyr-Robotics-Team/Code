...
@Autonomous(name = "DepotAutoRed")
public class DepotAutoRed extends LinearOpMode {
    ...
    private Servo intakeWheelLeft;         // dual mode servos
    ...
    // TIMING CONSTANTS
    // ===========================
    private final long DRIVE_FORWARD_TIME_1 = 1400;
    private final long DRIVE_FORWARD_TIME_2 = 500;
    private final long TURN_180_TIME = 1300;
    ...
    public void runOpMode() {
        ...
        // ---------------------------
        // 5. TURN 45 DEGREES LEFT
        // ---------------------------
        turnLeft(TURN_45_TIME);
